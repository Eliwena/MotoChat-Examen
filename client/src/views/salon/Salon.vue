          ...
          <div class="card-body p-4 text-center">
            <div class="mb-md-4 mt-md-4 pb-3">
              ...
              <div class="row d-flex justify-content-center">
                ...
                >
                  {{ salon.name }}
                  <span v-if="salon.count">{{ salon.count }}</span
                  ><span v-else> 0 </span> / {{ salon.size }}
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="mb-md-4 mt-md-4 pb-3">
              ...
              >
                ...
                <div class="text-end me-4">
                  <span
                    >Nombre de participant : {{ countUserLength }} /
                    {{ currentSalon.size }}</span
                  >
                </div>
                <hr />
                <div id="messages" class="messages">
                  ...
                  <div v-for="(msg, index) in messages" :key="index">
                    ...
                    <div v-else>
                      <p class="messageOtherUser" :class="msg.type">
                        <span class="nameUser"
                          >{{ msg.user.username }} à
                          {{ date(msg.createdAt) }} </span
                        >{{ msg.message }}
                ...
                <div class="mt-2">
                  <div class="writting">
                    <span
                      v-if="userTyping && userTyping != currentUser.username"
                      >{{ userTyping }} tape un message ...</span
                    >
                  </div>
